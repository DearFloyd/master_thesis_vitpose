...
total_epochs = 250
channel_cfg = dict(
    num_output_channels=136,  # halpe数据集包含136个关键点
    dataset_joints=136,
    dataset_channel=[
        list(range(136)),
    ],
...
data_root = '/workspace/cv-docker/joey04.li/datasets/halpe_pose_datasets/'
data = dict(
    samples_per_gpu=384,
    workers_per_gpu=16,
    ...
    train=dict(
        ...
        ann_file=f'{data_root}/halpe_train_v1.json',
    ...
    val=dict(
        type='TopDownHalpeDataset',
        ann_file=f'{data_root}/halpe_val_v1.json',
